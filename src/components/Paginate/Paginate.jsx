...
const Paginate = ({countriesPage, allCountries, paginate, maxPage, currentPage }) => {
  ...
  return (
    ...
    <div className={style.containerPaginate}>
        <button className={style.previousPage} onClick={previousPage} disabled = {currentPage === 1 || currentPage < 1}>
        ...
        <input type="text" placeholder="Númber" className={style.searchPage} autoComplete='off' value={input} onKeyDown={onkeyDown} onChange={handleChange}/>
        <p> of {maxPage} </p>

        <button className={style.nextPage} onClick={nextPage} disabled = {currentPage === maxPage || currentPage > maxPage}>
            <svg viewBox="0 0 20 27" fill="none" xmlns="http://www.w3.org/2000/svg">
